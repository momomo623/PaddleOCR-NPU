...
import numpy as np
from pt_self_attention import WrapEncoderForFeature
from pt_self_attention import WrapEncoder
...
class GSRM(nn.Module):
    ...
    def forward(self, inputs, gsrm_word_pos, gsrm_slf_attn_bias1,
        ...
        # word1 = F.pad(word_ids.type(torch.float32), [1, 0], value=1.0 * pad_idx, data_format="NLC")
