...
if __name__ == '__main__':
    ...
    parser.add_argument("--dict_path", type=str, help='Assign the paddleOCR trained dict_path')
    ...
    converter = PPOCRv3RecConverter(cfg, paddle_pretrained_model_path, **kwargs)
    ...
    save_name = 'ch_ptocr_v3_rec_infer_nodistill.pth'
