...
from .ppyolo_utils import NameAdapter
...
class ResNet(nn.Module):
    ...
    def __init__(self,
        ...
        for i in range(num_stages):
            ...
            self.res_layers.add_module(res_name,
                                       Blocks(
                                           block,
                                           self.ch_in,
                                           ch_out_list[i],
